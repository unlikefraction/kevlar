...
// Select: composite BaseInput + BaseOverlay.
...
// Dropdown uses BaseOverlay slots (onClickOutside, onEscape, Tab.trap: false).
// Dev-fill: data, onSearch, onSelect, onOpen, onNoResults.
...
export type KevlarSelectProps = MantineSelectProps & {
  // REQUIRED — dev-fill
...
export function Select(props: KevlarSelectProps) {
  const {
  ...
  spec.states.disabled.screenreader.state.disabled = true;
  ...
  return (
    <MantineSelect
      ...
      value={interaction.value as string | null}
