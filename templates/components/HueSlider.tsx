import { HueSlider as MantineHueSlider, type HueSliderProps as MantineHueSliderProps } from '@mantine/core';
import {
  baseInputStates,
  baseInputActions,
  baseInputInput,
...
// HueSlider inherits Slider pattern.
// screenreader.role: slider.
// Pre-configured: min=0, max=360, step=1.
...
const screenreaderOnValueChange = (v: number) => `Hue: ${v}\u00B0`;


// ─── PROPS ─────────────────────────────────────────────────────

export type KevlarHueSliderProps = MantineHueSliderProps & {
  // REQUIRED
...
export function HueSlider(props: KevlarHueSliderProps) {
  const {
